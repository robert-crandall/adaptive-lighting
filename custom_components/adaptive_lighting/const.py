...
CONF_SUNRISE_TIME_COLOR = "sunrise_time_color"
...
CONF_SUNSET_TIME_COLOR = "sunset_time_color"
...
VALIDATION_TUPLES = [
    ...
    (CONF_SUNRISE_TIME_COLOR, NONE_STR, str),
    ...
    (CONF_SUNSET_TIME_COLOR, NONE_STR, str),
...
EXTRA_VALIDATION = {
    ...
    CONF_SUNRISE_TIME_COLOR: (cv.time, str),
    ...
    CONF_SUNSET_TIME_COLOR: (cv.time, str),
}
