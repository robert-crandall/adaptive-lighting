...
| `min_sunrise_time`          | Make the virtual sun rise no earlier than a specific time while still allowing for even later times based on the real sun                                                                                                 | False    | None           | time    |                                                                                                                                                                                  | False    | None           | time    |
| `max_sunrise_time`          | Make the virtual sun rise at no later than a specific time while still allowing for even earlier times based on the real sun                                                                                                 | False    | None           | time    |
...
| `min_sunset_time`           | Make the virtual sun set no earlier than a specific time while still allowing for even later times based on the real sun                                                                                                   | False    | None           | time    |
| `max_sunset_time`           | Make the virtual sun set no later than a specific time while still allowing for even earlier times based on the real sun                                                                                                   | False    | None           | time    |
